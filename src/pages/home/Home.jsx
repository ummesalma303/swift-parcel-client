...
const Home = () => {
    ...
    return (
        <div className=''>
            ...
            <div className="mb-16">
            <h2 className='text-center font-semibold text-3xl mb-6 w-11/12 mx-auto '>The Top Delivery Man</h2>
           <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
           {
            ...
            <h2 className='text-center font-semibold text-3xl mb-6 w-11/12 mx-auto '>Recent Booked Parcel</h2>
            <RecentParcel/>
            </div>
