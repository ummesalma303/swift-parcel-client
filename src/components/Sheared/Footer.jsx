...
const Footer = () => {
    return (
        <div className='bg-gradient-to-tl from-indigo-400 dark:from-[#181745] to-transparent text-white'>
          <div className="relative w-full">
            {/* footer content */}
          <div className="absolute bottom-0 w-full text-black dark:text-white z-20">
